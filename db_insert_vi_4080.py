...
# Data to insert
piezas_data = [
    ("VI", "4080"),  # Add more rows here as needed
]
...
trapecios_data = [
    (1, 1, 0.400, 0.400, 0.800),  # (tipo_seccion, posicion, base_inf, base_sup, altura)
    (5140, 1, 0.400, 0.400, 0.123),
    (5140, 2, 0.400, 0.240, 0.027),
    (5140, 3, 0.240, 0.130, 0.070),
    (5140, 4, 0.130, 0.130, 0.400),
    (5140, 5, 0.130, 0.240, 0.050),
    (5140, 6, 0.240, 0.400, 0.012),
    (5140, 7, 0.400, 0.400, 0.118),
]
...
print("Se insertaron los datos de: VI - 4080")