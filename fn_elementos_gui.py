...
#         cordon['layout'].addWidget(cordon['num_cordones'][-1])
#         cordon['layout'].addWidget(cordon['tpi'][-1])

# def add_cordon(self):
#     index = len(self.dynamic_diametros_arm_act)
#     layout = QVBoxLayout()
#     label = QLabel(f"Cordon {index + 1}")
#     combo = QComboBox()
#     result = QLineEdit()
...
#         layout.addWidget(nc)
#         layout.addWidget(tp)
#     self.ui.gridLayout.addLayout(layout, 0, index + 1)
