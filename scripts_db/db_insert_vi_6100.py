...
# Data to insert
piezas_data = [
    ("VI", "6100"),  # Add more rows here as needed
]
...
trapecios_data = [
    (1, 1, 0.600, 0.600, 1.000),  # (tipo_seccion, posicion, base_inf, base_sup, altura)
    (5140, 1, 0.600, 0.600, 0.100),
    (5140, 2, 0.600, 0.240, 0.080),
    (5140, 3, 0.240, 0.140, 0.100),
    (5140, 4, 0.140, 0.140, 0.500),
...
print("Se insertaron los datos de: VI - 6100")