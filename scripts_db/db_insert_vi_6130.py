...
# Data to insert
piezas_data = [
    ("VI", "6130"),  # Add more rows here as needed
]

parametros_data = [
    (1, 1),  # (tipo_seccion, trapecios)
    (5140, 7),  # (tipo_seccion, trapecios)s
]

trapecios_data = [
    (1, 1, 0.600, 0.600, 1.300),  # (tipo_seccion, posicion, base_inf, base_sup, altura)
    (5140, 1, 0.600, 0.600, 0.100),
    (5140, 2, 0.600, 0.240, 0.080),
    (5140, 3, 0.240, 0.140, 0.100),
    (5140, 4, 0.140, 0.140, 0.800),
    (5140, 5, 0.140, 0.240, 0.050),
    (5140, 6, 0.240, 0.600, 0.033),
    (5140, 7, 0.600, 0.600, 0.137),
]
...
print("Se insertaron los datos de: VI - 6130")