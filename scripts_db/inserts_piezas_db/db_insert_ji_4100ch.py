...
# Data to insert
piezas_data = [
    ("JI", "4100_CH"),  # Add more rows here as needed
]
...
trapecios_data = [
    (2, 1, 0.400, 0.400, 1.000),  # (tipo_seccion, posicion, base_inf, base_sup, altura)
    (3, 1, 0.400, 0.400, 0.120),
    (3, 2, 0.400, 0.110, 0.080),
    (3, 3, 0.110, 0.110, 0.600),
...
print("Se insertaron los datos de: JI - 4100_CH")
