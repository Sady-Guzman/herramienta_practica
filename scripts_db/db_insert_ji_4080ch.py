...
# Data to insert
piezas_data = [
    ("JI", "4080_CH"),  # Add more rows here as needed
]
...
trapecios_data = [
    (2, 1, 0.400, 0.400, 0.800),  # (tipo_seccion, posicion, base_inf, base_sup, altura)
    (3, 1, 0.400, 0.400, 0.080),
    (3, 2, 0.400, 0.900, 0.080),
    (3, 3, 0.090, 0.090, 0.480),
    (3, 4, 0.090, 0.400, 0.080),
    (3, 5, 0.400, 0.400, 0.080),
]
...
print("Se insertaron los datos de: JI - 4080_CH")
