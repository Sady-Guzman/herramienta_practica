...
def save_pieza_data(self, es_temp):
    ...
    if not familia or not modelo:
        ...
        popup_no_temp("Debe seleccionar una Familia y un Modelo para guardar.")
        return
    ...
    try:
        ...
        popup_no_temp("La pieza ha sido guardada exitosamente.")
    except Exception as e:
        print(f"Error al guardar en la base de datos: {e}")
        popup_no_temp(f"Error al guardar la pieza: {e}")



def popup_no_temp(message):
